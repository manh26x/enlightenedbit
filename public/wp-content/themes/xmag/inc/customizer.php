...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	class Xmag_Important_Links extends WP_Customize_Control {
		...
		public function render_content() {
			$important_links = array(
				'upgrade' => array(
				'link' => esc_url('https://www.designlabthemes.com/xmag-plus-wordpress-theme/?utm_source=WordPress&utm_medium=customizer_link&utm_campaign=xmag_upsell'),
	...
	class Xmag_Plus_Version extends WP_Customize_Control {
		...
		$pro_version_link = esc_url( 'https://www.designlabthemes.com/xmag-plus-wordpress-theme/?utm_source=WordPress&utm_medium=customizer_link&utm_campaign=xmag_upsell' );
...
function xmag_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_section('xmag_logo_section', array(
		'title' => __('Header Logo', 'xmag'),
		'priority' => 10,
		'panel' => 'xmag_panel',
	) );
	...
	// Logo
	$wp_customize->add_setting('xmag_logo', array(
		'default' => '',
		'sanitize_callback' => 'esc_url_raw',
	) );

	$wp_customize->add_control(new WP_Customize_Image_Control($wp_customize, 'xmag_logo', array(
		'label' => __('Upload your logo', 'xmag'),
		'section' => 'xmag_logo_section',
		'setting' => 'xmag_logo',
	) ) );

	// Logo Size
	$wp_customize->add_setting( 'xmag_logo_height', array(
		'default' => 40,
		'sanitize_callback' => 'absint',
	) );

	$wp_customize->add_control( 'xmag_logo_height', array(
		'label' => __( 'Logo Max Height', 'xmag' ),
		'section'  => 'xmag_logo_section',
		'type'     => 'number',
	) );

	// Display Tagline under the Logo
	$wp_customize->add_setting( 'xmag_logo_tagline', array(
		'default' => '',
		'sanitize_callback' => 'xmag_sanitize_checkbox',
	) );

	$wp_customize->add_control( 'xmag_logo_tagline', array(
		'label'    => __( 'Display Tagline under the Logo', 'xmag' ),
		'section'  => 'xmag_logo_section',
		'type'     => 'checkbox',
	) );
