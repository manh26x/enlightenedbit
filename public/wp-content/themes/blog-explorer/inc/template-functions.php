 ...
 * @return array
 */
function blog_explorer_body_classes( $classes ) {
...
add_filter( 'body_class', 'blog_explorer_body_classes' );

/**
 * Add a pingback url auto-discovery header for single posts, pages, or attachments.
 */
function blog_explorer_pingback_header() {
	if ( is_singular() && pings_open() ) {
		printf( '<link rel="pingback" href="%s">', esc_url( get_bloginfo( 'pingback_url' ) ) );
	}
}
add_action( 'wp_head', 'blog_explorer_pingback_header' );

/**
 * blog_explorer Excerpt Length
 *
 * @since blog_explorer 1.0.0
 *
 * @param null
 * @return void
 */

if ( ! function_exists( 'blog_explorer_excerpt_length' ) ) :
   ...
   */
  function blog_explorer_excerpt_length( $length ) {
...
add_filter( 'excerpt_length', 'blog_explorer_excerpt_length', 999 );
